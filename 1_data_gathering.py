...
for index, row in run_control.iterrows():
    ...
    var_list = ["B02001_001E","B02001_002E","B02001_003E","B02001_003M","B02001_004E","B02001_005E","B02001_006E","B02001_007E","B02001_008E","B02001_009E","B02001_010E"]
    ...
    # -------------------------------------------------------------------------
    raw_hmda = pd.read_pickle(f'raw_hdma_data/{state}_{year}_raw.pkl')
    ...
    # Renaming a couple of variables to make them more intuitive for the csv file.
    ...
    final = final[["NAME","total_purchases","black_purchases","pct_black_purchases","total_population","black_population","pct_black_pop","rate_disparity","rate_ratio"]]
